...
public class TableItems extends JTable {
    ...
    public enum Column {
        ...
        CODE(2,90,"Código",String.class, false),
        CATEGORY(3,100,"Categoría",String.class, false),
        DESCRIPTION(4,280,"Descripción",String.class, false),
        COLOR(5,100,"Color",String.class, false),
        UNIT_PRICE(6,100,"P.Unitario",String.class, false),
        STOCK(7,100,"Stock",String.class, false),
        CREATED_AT(8,100,"Creado",String.class, false),
        UPDATED_AT(9,100,"Actualizado",String.class, false);
