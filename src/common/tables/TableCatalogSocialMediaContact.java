...
public class TableCatalogSocialMediaContact extends JTable {
    
    public TableCatalogSocialMediaContact() {       
    ...
    public enum Column {
        ...
        CREATED_AT(3,120,"Creado",String.class, false),
        UPDATED_AT(4,120,"Actualizado",String.class, false);
