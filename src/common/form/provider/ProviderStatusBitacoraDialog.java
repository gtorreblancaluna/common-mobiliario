...
public class ProviderStatusBitacoraDialog extends javax.swing.JDialog {
    ...
    public ProviderStatusBitacoraDialog(
            java.awt.Frame parent, boolean modal, Long rentaId, String folio,
            DatosGenerales datosGenerales, Usuario user) {
        super(parent, modal);
        initComponents();
    ...
    private void save () {
        ...
        statusProviderByRenta.setUser(globalUser);
        ...
        try {
            ...
            //Utility.pushNotification(String.format("Folio: %s, Usuario %s,  Estatus al orden proveedor registrado [%s]"
              //      , this.folio
                //    , iniciar_sesion.usuarioGlobal.getNombre() + " " + globalUser.getApellidos()
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProviderStatusBitacoraDialog dialog = new ProviderStatusBitacoraDialog(new javax.swing.JFrame(), true, null, null, null, null);
